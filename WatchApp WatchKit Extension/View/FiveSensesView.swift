...
struct ModalView: View {
    ...
    var body: some View {
        ...
        self.audioPlayer?.volume = digitalCrownRotation(.constant(1.0),from: 1, through: 5, by: 0.1,sensitivity: .low, isContinuous: true, isHapticFeedbackEnabled: true) as! Float
